                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                            <form method="post" action="{{route('admin.applications.update',[$application->id])}}"  class="form form-horizontal" id="profileForm">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
                            ...
                            <div class="col-md-3">
                                ...
                                <h4>Почта  : {{($application->client)->email ?? ""}}</h4>d
