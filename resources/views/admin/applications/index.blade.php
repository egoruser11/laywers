...
@section('content')
    ...
    <div class="table-responsive">
        <table class="table table-striped">
            <a href="{{route('admin.applications.create')}}" class="btn btn-outline-primary waves-effect">Новая
                заявка</a>
            <thead>
            <div class="row mb-2">
                <div class="col-md-12 col-lg-12">
                    <form role="form" method="get" action="{{route('admin.applications.index')}}">
                        <br>
                        <div class="row">
                ...
                <tr>
                    ...
                    <td>
                        @if($application->client_id)
                            <a href="{{route('admin.clients.edit',[$application->client_id])}}"
                    ...
                    <td>
                        @if($application->lawyer_id)
                            <a href="{{route('admin.users.edit',[$application->lawyer_id])}}"
