...
@section('content')
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    <a href="{{route('admin.clients.create')}}" class="btn btn-outline-primary waves-effect">Новый
                        клиент</a>
                    <thead>
                    <div class="row mb-2">
                        <div class="col-md-12 col-lg-12">
                            <form role="form" method="get" action="{{route('admin.clients.index')}}">
                                <br>
                                <div class="row">
                    ...
                    @foreach($clients as $client)
                        <tr>
                            ...
                            <td><a href="{{route('admin.clients.destroy',$client->id)}}"
