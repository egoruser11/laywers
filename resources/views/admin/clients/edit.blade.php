                                    ...
                                    <form method="post" action="{{route('admin.clients.update',[$client->id])}}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" id="profileSurname"
                                                           ...
                                                           autocomplete="off"
                                                           class="form-control" name="full_name" placeholder=""
                                                           readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" id="profileSurname" value="{{$client->document}}"
                                                           autocomplete="off"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="email" id="profileSurname" value="{{$client->email}}"
                                                           autocomplete="off"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="datetime-local" id="profileName"
                                                           value="{{$client->date_born}}" autocomplete="off"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="string" id="profileSurname"
                                                           value="{{$client->document_number}}" autocomplete="off"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" id="profileSurname"
                                                           value="{{$client->residential_address}}" autocomplete="off"
                                                           class="form-control" name="residential_address"
                                                           placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" id="profileSurname"
                                                           value="{{$client->registration_address}}" autocomplete="off"
                                                           class="form-control" name="registration_address"
                                                           placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" id="profileSurname" value="{{$client->phone}}"
                                                           autocomplete="off"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($application->manager_id)
                                                            <a href="{{route('admin.users.edit',[$application->manager_id])}}"
