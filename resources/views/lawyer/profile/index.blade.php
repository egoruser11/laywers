                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @endif
                                ...
                                @endif
                            <form action="{{route('admin.profile.update')}}"  method="post" class="form form-horizontal" id="profileForm">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
                            ...
                            <form action="{{route('lawyer.profile.update.password')}}"  method="post" class="form form-horizontal" id="passwordForm">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
