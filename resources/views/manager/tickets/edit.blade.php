                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <form method="post" action="{{route('manager.applications.update',[$application->id])}}"  class="form form-horizontal" id="profileForm">
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-12">
                                                ...
                                                {{--                                                </div>--}}
                                                {{--                                                <div class="col-md-8">--}}
                                                {{--                                                   {{($application->work_start_date_and_time)->addHours($application->count_hours_work)}}--}}
                                                {{--                                                </div>--}}
                                                {{--                                            </div>--}}
                                                {{--                                        </div>--}}
                                                <div class="col-12">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <h4>Время работы :  {{config('lawyer.schedule.end_at')}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
